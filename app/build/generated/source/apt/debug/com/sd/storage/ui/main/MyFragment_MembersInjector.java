...
public final class MyFragment_MembersInjector implements MembersInjector<MyFragment> {
  ...
  public MyFragment_MembersInjector(MembersInjector<BaseTabFragment> supertypeInjector, Provider<AppStore> appStoreProvider) {  
  ...
  public static MembersInjector<MyFragment> create(MembersInjector<BaseTabFragment> supertypeInjector, Provider<AppStore> appStoreProvider) {  
      return new MyFragment_MembersInjector(supertypeInjector, appStoreProvider);
  }
}
