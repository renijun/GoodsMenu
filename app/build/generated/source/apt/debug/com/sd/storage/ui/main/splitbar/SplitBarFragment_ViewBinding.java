...
public class SplitBarFragment_ViewBinding<T extends SplitBarFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public SplitBarFragment_ViewBinding(final T target, View source) {
    this.target = target;
