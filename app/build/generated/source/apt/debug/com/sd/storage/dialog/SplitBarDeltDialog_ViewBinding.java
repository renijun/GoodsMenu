...
public class SplitBarDeltDialog_ViewBinding<T extends SplitBarDeltDialog> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public SplitBarDeltDialog_ViewBinding(final T target, View source) {
    this.target = target;
