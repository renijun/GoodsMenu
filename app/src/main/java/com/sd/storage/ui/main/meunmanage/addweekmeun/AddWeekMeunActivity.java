...
public class AddWeekMeunActivity extends BaseSCActivity implements StoreAddMeunAdapter.OnItemMeunClickListener {
        ...
        */
        ...
        allMeunStore.toMainSubscription(AllMeunStore.AddVegeChangeError.class, new Action1<AllMeunStore.AddVegeChangeError>() {
            ...
            public void call(AllMeunStore.AddVegeChangeError changeError) {
                getDisplay().hideWaittingDialog();
                ToastUtils.showBaseToast(getString(R.string.add_err), AddWeekMeunActivity.this);
            }
        });
    ...
    public void onItemClick(int point) {
        ...
        allMeunActionsCreator.addVegeWeek(vageModel.vegeid, vageModel.vegename, vageModel.vegedesc, vageModel.vegeimg, vageModel.heatid, dayid, typeid,vageModel.vegecomment, UrlManager.getUSERID());
