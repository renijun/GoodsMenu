...
public class AllMeunActionsCreator extends ActionsCreator {
     ...
     * @param vegeid
     */
    public void addVegeWeek(String vegeid,String vegename,String vegedesc,String vegeimg,String heatid,String dayid,String typeid ,String vegecomment,String userid) {
        ...
        params.put("vegecomment",vegecomment);
